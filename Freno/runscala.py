...
parser.add_argument('--scala','-s',type=int, help='size of scaled dataset slices', required=True)
...
def main():
    ...
    totalDB = get_DB_path("/root/mpiFreno/incdatasets", database)
    ...
    #inc_number = 0
    dbPath = os.path.join(dbdir, "{0}_{1}.txt".format(database,scala))
